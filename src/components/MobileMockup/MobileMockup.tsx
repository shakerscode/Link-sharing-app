...
function MobileMockup({
  ...
  return (
    <>
      ...
      <div
        className="w-2/3 h-full absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center overflow-y-scroll "
        style={{
          left: "50%",
          top: "0%",
      ...
      >
        ...
        <div className="w-full overflow-y-scroll h-[250px] hide-scrollbar">
